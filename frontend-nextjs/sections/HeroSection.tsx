    ...
    <section className="mt-16 relative flex items-center justify-center overflow-hidden pt-20" style={{ minHeight: 'calc(100vh - 80px)' }}>
      ...
      <div className="relative z-10 max-w-8xl mx-auto px-4 text-center mt-8">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="pb-10">
          <h2 className="text-amber-400 font-bold tracking-[0.2em] uppercase text-sm md:text-base underline underline-offset-4">
            March 5-6, 2026
          </h2>
          <h3 className="text-amber-400 font-bold tracking-[0.15em] uppercase text-sm md:text-base mt-2 underline underline-offset-4">
          ...
          <p className="text-slate-300 text-base md:text-lg max-w-2xl mx-auto mb-6 mt-0 md:-mt-4 lg:-mt-6 font-light leading-relaxed">
