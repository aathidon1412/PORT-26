        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className={`space-y-3 ${colors.textTertiary} text-sm`}>
              <li>
                <Link href="/events" className={`${theme === 'light' ? 'hover:text-amber-600' : 'hover:text-amber-400'} transition-colors duration-300`}>All Events</Link>
              </li>
              <li>
                <Link href="/workshops" className={`${theme === 'light' ? 'hover:text-amber-600' : 'hover:text-amber-400'} transition-colors duration-300`}>Workshops</Link>
              </li>
              <li>
                <Link href="/tickets" className={`${theme === 'light' ? 'hover:text-amber-600' : 'hover:text-amber-400'} transition-colors duration-300`}>Tickets</Link>
              </li>
            </ul>
          </div>
            ...
            <ul className={`space-y-4 ${colors.textTertiary} text-sm`}>
              <li>
                <a className={`flex items-start space-x-3 ${theme === 'light' ? 'hover:text-amber-600' : 'hover:text-amber-400'} transition-colors duration-300`} href="https://maps.app.goo.gl/PtBgsfmxoSJzoBa76?g_st=aw" target="_blank" rel="noopener noreferrer">
                  <MapPin className={`w-5 h-5 ${theme === 'light' ? 'text-violet-600' : 'text-violet-500'} shrink-0 mt-0.5`} />
