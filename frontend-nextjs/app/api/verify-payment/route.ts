...
const REQUIRED_ACCOUNT_NAME = 'VAISHNAVI DALI A';
  ...
  try {
    ...
    if (!accountNameFound) {
      return NextResponse.json({
        ...
        message: `The account holder name "VAISHNAVI DALI A" was not detected in your screenshot. Please upload a screenshot from the correct UPI account.`,
        candidates: [],
      });
    }
