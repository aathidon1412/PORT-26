...
const REQUIRED_ACCOUNT_NAME = 'P ABINAYA';
  ...
  try {
    ...
    if (!accountNameFound) {
      return NextResponse.json({
        ...
        message: `The account holder name "P ABINAYA" was not detected in your screenshot. Please upload a screenshot from the correct UPI account.`,
        candidates: [],
      });
    }
