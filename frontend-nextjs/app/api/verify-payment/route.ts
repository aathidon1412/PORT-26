...
const REQUIRED_ACCOUNT_NAME = 'Nivedha Ravi';
  ...
  try {
    ...
    if (!accountNameFound) {
      return NextResponse.json({
        ...
        message: `The account holder name "Nivedha Ravi" was not detected in your screenshot. Please upload a screenshot from the correct UPI account.`,
        candidates: [],
      });
    }
